       ...
       <div className="max-w-6xl mx-auto px-4">
         ...
         <div className="bg-white rounded-3xl shadow-lg overflow-hidden mb-16 flex flex-col md:flex-row group hover:shadow-2xl transition-shadow duration-300">
          <div className="md:w-1/2 h-24 md:h-32 overflow-hidden">
               <img src="/webimagesall/jana1.jpg" alt="Jana Waterfall" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110" />
            </div>
            <div className="md:w-1/2 p-10 flex flex-col justify-center">
               ...
               <a href={WHATSAPP_LINK} target="_blank" rel="noreferrer" className="inline-block bg-forest-600 text-white px-8 py-3 rounded-full font-bold w-fit hover:bg-forest-700 transition-colors">Plan a Visit</a>
            </div>
         </div>
         ...
         <div className="text-center mt-12 bg-stone-100 p-8 rounded-2xl">
           ...
           <a href={WHATSAPP_LINK} target="_blank" rel="noreferrer" className="text-forest-700 font-bold underline hover:text-forest-900 text-lg">Chat with us to customize your tour</a>
         </div>
